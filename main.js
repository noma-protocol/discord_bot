    ...
    if (command.startsWith('subscribe')) {
        ...
        if (!message.guild) { // Check if the message is in a DM
            ...
            message.reply(`Please post this text on X/Twitter: \n
                "I want to whitelist for the Noma protocol bootstrap event. Unique code: ${uniqueCode}. Follow Noma on X/Twitter https://x.com/nomaprotocol and on Discord https://discord.gg/nomaprotocol" \n\n
